      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[440px]">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            <Link
              href="/"
              className="group inline-flex flex-col items-center gap-2.5 transition-transform duration-200 hover:scale-[1.02] focus-visible:outline-[var(--color-signal)]"
              aria-label="KNEST Home"
            >
              <Logo size="md" />
              <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[var(--color-ink-muted)] group-hover:text-[var(--color-signal)] transition-colors">
          ...
          {/* Premium Glass Card */}
          <div className="relative overflow-hidden rounded-2xl border border-[var(--color-line)]/70 bg-white/95 p-7 sm:p-9 shadow-[0_20px_50px_-12px_rgba(13,19,33,0.08),0_1px_3px_rgba(0,0,0,0.04)] backdrop-blur-xl">
