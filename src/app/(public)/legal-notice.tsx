 ...
 *
 * Both are linked from the footer of every page in the app, and both
 * returned 404 — a link crawl over the fifteen internal targets on the public
 * site found these two, on all ten pages that render the footer. The pages
 * existed before the visual re-brand and were dropped along the way.
 *
