  ...
  return (
    <>
      <PageHeader
        ...
        description="KNEST is run by a university, not an advertising business. We collect what running programs actually requires, and we would rather tell you exactly what that is than write three pages that avoid the question."
      />
